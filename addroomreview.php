...
<html lang="en">
  ...
  <body>
    ...
    <p>
      <a href="currentbooking.php">[Return to the booking listing]</a>|| <a href="makebooking.php">[Return to the main page]</a>
    </p>
...
require('config.php'); 
          ...
          if(isset($_POST['updatereview']))
        {
         ...
         ?> <p>Review made by <?=  $row1["customer"]; ?> </p>
      <input type="hidden" value="
                            <?= $row1["booking_id"];?>" name="booking_id">
      <p>Room review: <textarea name="review">
                                    <?= $review; ?>
                                </textarea>
      </p> <?php
